        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <motion.div className="bg-white/5 p-8 rounded-xl backdrop-blur-xl">
            ...
            <div className="space-y-4">
              <a href="mailto:arshiawork2303@gmail.com" className="flex items-center space-x-3 text-blue-400">
                <Mail size={18} />
                <span>arshiawork2303@gmail.com</span>
              </a>
              <a href="https://www.linkedin.com/in/arshia-chandarki-891a03289/" target="_blank" className="flex items-center space-x-3 text-blue-400">
                <Linkedin size={18} />
                <span>linkedin.com/in/arshiachandarki</span>
              </a>
              <a href="https://github.com/arshia-sudo" target="_blank" className="flex items-center space-x-3 text-blue-400">
                <Github size={18} />
                <span>github.com/arshia-sudo</span>
              </a>
            </div>
          </motion.div>
