...
import ayushiImage from './images/ash.jpg';
...
import resume from './images/new_resume_arshia.pdf';
import certificate1 from './images/infosys_spring_java.pdf';
import certificate2 from './images/GDG.pdf.pdf';
import certificate3 from './images/Coursera wordpress.pdf';
import certificate4 from './images/Ey gds_internship_edunet.pdf';
...
<h1 className="font-poppins ...">Hello I'm</h1>
  ...
  >
    ...
    <div className="flex justify-center gap-6 text-blue-300 text-xl">
      <a href="https://github.com/arshia-sudo" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:scale-110 transition">
        <FaGithub />
      </a>
      <a href="https://www.linkedin.com/in/arshia-chandarki-891a03289/" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:scale-110 transition">
        <FaLinkedin />
      </a>
      <a href="mailto:arshiawork2303@gmail.com" className="hover:text-white hover:scale-110 transition">
        <FaEnvelope />
      </a>
    </div>
  </div>
...
>
  ...
  Hey, I'm <span className="text-blue-400 font-semibold">Arshia Chandarki</span> — a Developer and AI Enthusiast with a love for crafting powerful, user-friendly web applications that actually make a difference. Whether it’s frontend finesse or backend logic, I thrive on turning complex ideas into clean, functional digital solutions.
</p>
    ...
    <div className="grid md:grid-cols-3 gap-16">
      ...
      <div className="flex flex-col items-center transform hover:scale-110 transition-all duration-500">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {['HTML', 'CSS', 'Java', 'Python','C/C++'].map((skill) => (
            <div
              key={skill}
      ...
      <div className="flex flex-col items-center transform hover:scale-110 transition-all duration-500">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {['React', 'Node.js', 'Express.js', 'Tailwind CSS', 'MySQL', 'MongoDB'].map((skill) => (
            <div
              key={skill}
      ...
      {[
        {
          ...
          period: '2024 - Present',
          description: 'Developing a car rental platform with user authentication and booking features.',
        },
        {
    ...
    <div className="relative border-l-2 border-blue-500/30 pl-6 space-y-12">
      {[
        ...
        },
        {
          ...
          institution: 'Kothari National School',
          period: '2020 - 2022',
          score: 'Percentage: 83 %',
        },
        {
      ...
      <footer className="py-6 border-t border-blue-900/30 bg-black text-center">
        <p className="text-gray-400 text-sm">© 2025 Arshia Chandarki. All rights reserved.</p>
      </footer>
    </div>
  );
}
